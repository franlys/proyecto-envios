    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-lg p-6 mb-6 border border-blue-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-2">Recolecciones totales</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-2">Pendientes de entrega</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 font-medium">Entregadas</p>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-2">USD declarados</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-600">Última Recolección</p>
              <p className="text-lg font-bold text-gray-900">
