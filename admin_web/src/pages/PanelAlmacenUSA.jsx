...
const PanelAlmacenUSA = () => {
  ...
  const handleCrearContenedor = async (e) => {
    ...
    // ✅ YA NO SE REQUIERE INPUT MANUAL
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-6 py-3 rounded-lg transition font-semibold ${tabActiva === 'activos'
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg transition font-semibold ${tabActiva === 'historial'
                      ? 'bg-indigo-600 text-white'
                      : 'bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300'
                    }`}
                >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className={`text-sm px-2 py-1 rounded ${contenedor.estado === 'abierto'
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6">
            ...
            <form onSubmit={handleCrearContenedor} className="space-y-6">
              <div className="bg-blue-50 text-blue-800 p-4 rounded-lg flex items-start gap-3">
                <Box className="mt-1" />
                <div>
                  <h3 className="font-bold">Generación Automática</h3>
                  <p className="text-sm mt-1">
                    El número de contenedor será generado automáticamente por el sistema 
                    siguiendo el formato: <strong>[PREFIJO]-CNT-[NÚMERO]</strong>
                    <br />
                    Ejemplo: EMI-CNT-0001
                  </p>
                </div>
              </div>
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <span className={`text-sm px-3 py-1 rounded inline-block mt-1 ${contenedorActivo.estado === 'abierto'
                  ? 'bg-emerald-100 text-emerald-800'
                ...
                >
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                      <span className={`px-3 py-1 rounded text-sm font-medium flex-1 sm:flex-none text-center ${factura.estadoItems === 'completo'
                          ? 'bg-emerald-100 text-emerald-800'
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-2xl w-full p-6">
        ...
        <div className="border border-slate-200 dark:border-slate-700 rounded-lg p-4 mb-4">
          <div className="flex justify-between items-start mb-3">
            ...
            <span className={`px-3 py-1 rounded text-sm font-medium ${resultadoGlobal.estado === 'pendiente'
                ? 'bg-emerald-100 text-emerald-800'
